...
class FilmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create film' do
    assert_difference('Film.count') do
      post films_url, params: { film: { characters_id: @film.characters_id, title: @film.title } }
    end
  ...
  test 'should update film' do
    patch film_url(@film), params: { film: { characters_id: @film.characters_id, title: @film.title } }
